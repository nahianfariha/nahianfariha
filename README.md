<h2 align="center">🎓CS & Engineering graduate with strong research interest in Generative AI, particularly Large Language Models, with an emphasis
on evaluation, hallucination analysis, and trustworthiness. My undergraduate thesis involved CNN-based
real-time object detection in computer vision. </h2>
...
- 🌐👩‍💻 [Academic Portfolio Website](https://nahianfariha.github.io)-A professional academic portfolio website to showcase my projects, research, and achievements, built with React, Vite, Tailwind CSS, Node.js, and deployed on Github Pages.  [Repository](https://github.com/nahianfariha/nahianfariha.github.io.git)
