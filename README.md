...
- 🛍️🔍 [ShopHallu: Benchmark & Evaluation Framework for Hallucination Detection in LLM-Generated Product Reviews](https://github.com/nahianfariha/ShopHallu) – Built a benchmark dataset and rule-guided annotation/evaluation pipeline to detect hallucination types in LLM-generated influencer-style product reviews, analyzing how model, prompt, and temperature drive hallucination rate and benchmarking automated detection against human-annotated ground truth; using GPT-4o-mini, Gemini-3.5-Flash, and Llama-3.1-8B-Instruct via OpenRouter with Python, Pandas, Scikit-learn, and Sentence-Transformers.
